  ...
  render() {
    ...
    return (
      <div id="login-screen" className="container-md full-pg fade-in">
        <a href="https://github.com/dcpesses/code-whisperer" className="github-corner"
        ...
        <div className="row row-cols-auto align-items-center justify-content-center my-5">
        ...
        <div className="row align-items-center justify-content-center my-4 row-info">
          <div className="col">
